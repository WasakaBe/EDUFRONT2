        ...
        <tbody>
          {currentItems.map((carrera) => (
            <tr key={carrera.id_carrera_tecnica}>
              ...
              <td>
                <button className="edit-button" onClick={() => openEditModal(carrera)}>Editar</button>
                <button className="delete-button" onClick={() => deleteCarreraTecnica(carrera.id_carrera_tecnica)}>Eliminar</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      {isModalOpen && (
        <div className="register-modal-overlay">
          <div className="register-modal-content">
            <form className='form-group' onSubmit={(e: FormEvent) => {
              e.preventDefault();
