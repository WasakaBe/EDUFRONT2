        ...
        <tbody>
          {sobreNosotros.map((item) => (
            <tr key={item.id_sobre_nosotros}>
              ...
              <td>
                <button className="edit-button" onClick={() => openEditModal(item)}>Editar</button>
                <button className="delete-button" onClick={() => deleteSobreNosotros(item.id_sobre_nosotros)}>Eliminar</button>
              </td>
            </tr>
          ))}
        </tbody>
