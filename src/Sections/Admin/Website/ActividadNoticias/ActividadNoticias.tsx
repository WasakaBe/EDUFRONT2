      ...
      {isModalOpen && (
        <div className="modal-info">
          <div className="modal-content-info">
            <form className='form-group' onSubmit={isEditing ? editActividadNoticia : addActividadNoticia}>
              ...
              <div className='buttons'>
                ...
                <span className="delete-button" onClick={() => setIsModalOpen(false)}>&times;</span>
              </div>
            </form>
          </div>
        </div>
